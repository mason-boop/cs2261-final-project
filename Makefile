...
SOURCES            = main.c game.c myLib.c sound.c start1.c start2.c start3.c instructions.c furtherclouds.c clouds.c pause1.c pause2.c pause3.c lose.c lose_alt.c spritesheet.c CoralReef.c CoralReefFast.c LastParadise.c OhSFX.c
CCPATH             = /usr/bin
